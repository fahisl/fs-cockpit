...
//const int downSpeedTable[6] = {0, 40, 50, 80, 125, 250};  // Actuator speed function
const int upSpeedTable[6]   = {0, 80, 100, 110, 125, 250};  // Actuator speed function
const int downSpeedTable[6] = {0, 80, 100, 110, 125, 250};  // Actuator speed function
const char commandCharacter = 'B';  // All valid commands are expected to start with this character
...
void getDesiredAngle() {
  ...
  potDesired = map(desiredAngle, -30, 30, potMin, potMax); 
}
...
void runActuator() {
  int potDelta = abs(potCurrent - potDesired) / 13.4;  
